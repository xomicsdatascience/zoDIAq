...
outFile = 'Data/Output/csodiaq_lib-human-20peaks-noloss-pt2mz-400to2000_exp-n1b_nosqrt.csv'
...
for f in files:
    ...
    check = True
files = [x for x in csodiaq if '20peaks' in x]



for x in files:
    figure.write_meta_analysis_files(x)
'''
